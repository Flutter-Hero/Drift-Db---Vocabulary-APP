        ...
        return Form(
          ...
          child: Column(
            children: [
              ...
              DropdownButton(
                value: vocabularProvider.dropDownSelectedCategory,
                  items: List.generate(vocabularProvider.allCategories.length,
                      (index) {
                    return DropdownMenuItem(
                      value: vocabularProvider.allCategories[index],
                        child:
                            Text(vocabularProvider.allCategories[index].name));
                  }),
                  onChanged: (value) {
                    vocabularProvider.setDropDownSelectedCategory(value!);
                  }),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Row(
                  children: [
                    Text("Is Mastered"),
                    Checkbox(
                        value: vocabularProvider.checkBoxValue,
                        onChanged: (v) {
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      VocabularyCompanion vc = VocabularyCompanion(
                        categoryId: db.Value(vocabularProvider.dropDownSelectedCategory!.id),
                      ...
                      if (widget.vd == null) {
                        ...
                        categoryId: db.Value(vocabularProvider.dropDownSelectedCategory!.id),
                            ...
                            exampleSentence: db.Value(_exampleController.text == ''
                                ...
                                : _exampleController.text),
                            mastered:
                                db.Value(vocabularProvider.checkBoxValue));
